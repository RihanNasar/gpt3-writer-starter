...
const callGenerateEndpoint = async () => {
  ...
  return (
    ...
    <label for="what stage of life are you at right now ?" className="block mb-8 text-sm left-0 relative font-medium text-gray-900 dark:text-white">What stage of life are you at right now ?</label>
            <select onChange={handleChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block md:w-4/12 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 sm:w-8/12">
    ...
    <div className='flex justify-center align-center m-28 sm:m-10'>
      ...
      <div className="w-6/12 h-40  mb-4 border border-gray-200 rounded-lg  dark:bg-gray-800 dark:border-gray-600 sm:min-w-max">
